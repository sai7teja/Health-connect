...
4. Create a new data source:
   - **Authentication**: Use GCP service account JSON
   - **Project**: `your-gcp-project-id`
   - **Default Dataset**: `health_analytics`

> **Tip**: Create a separate read-only service account for Grafana with only `roles/bigquery.dataViewer` and `roles/bigquery.jobUser`.
